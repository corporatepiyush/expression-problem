...
/* package expr-fun-1.0 */
#define VERSION_expr_fun "1.0"
#define MIN_VERSION_expr_fun(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "expr-fun-1.0"

#define CURRENT_PACKAGE_KEY "expr-fun-1.0"
